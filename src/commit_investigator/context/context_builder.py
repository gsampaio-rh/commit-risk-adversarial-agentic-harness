...
class CommitContextBuilder:
    ...
    def build(
        ...
        include_test_adjacency: bool = False,
        include_blame_snippets: bool = False,
        ...
        Optional bundle expansion appends test-adjacency and blame sections.
        """
        ...
        expansion_active = include_test_adjacency or include_blame_snippets
        assemble_cap = (
            max(1, max_diff_chars - EXPANSION_RESERVED_CHARS)
            if expansion_active
            else max_diff_chars
        )
        ...
        if expansion_active and raw_diff is not None:
            diff = append_context_expansion(
                diff or "",
                raw_diff,
                commit_id,
                self._git,
                include_test_adjacency=include_test_adjacency,
                include_blame_snippets=include_blame_snippets,
